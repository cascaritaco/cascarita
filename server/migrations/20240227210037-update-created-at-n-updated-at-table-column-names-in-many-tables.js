...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.renameColumn("Seasons", "updatedAt", "updated_at");
    await queryInterface.renameColumn("Seasons", "createdAt", "created_at");
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.renameColumn("Seasons", "updated_at", "updatedAt");
    await queryInterface.renameColumn("Seasons", "created_at", "createdAt");
